  ...
  return (
    <div className="bg-[--bgSecondary] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <h3 className="mt-4 text-center text-lg font-normal leading-8 text-[--textSecondary]">Acercamos tu comuna a la economía del futuro! Conozca más sobre nuestros servicios.</h3>
