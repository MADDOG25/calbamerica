        ...
        <div className="mx-auto max-w-2xl py-44 sm:py-44 lg:py-48">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-[--mediumGreen] px-3.5 py-2.5 text-sm font-semibold text-[--whiteGray] shadow-sm hover:bg-[--mediumGreen] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[--mediumGreen]"
              >
